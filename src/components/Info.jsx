            ...
            <div className="intro-wrapper">
                ...
                <div className='w_0_1_wrapper'>
                    <div style={{ width: '65%' }}>
                        ...
                        Hi, I'm Tarun, a Full Stack Developer with over {expNum.toFixed(1)} years of experience based in India. I am passionate about crafting innovative web solutions and coding dynamic applications that make an impact.
                        </p>
                    </div>
